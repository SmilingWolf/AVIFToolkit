...
for filename in statsDict:
	...
	totalPixels += stats[1]
	totalSize += stats[0]
print('%s %d %d %0.4f %0.4f %0.4f %0.4f %0.4f' % (inFile.split('.')[-2], totalPixels, totalSize, totalPSNR/totalPixels, totalSSIM/totalPixels, totalPSNRHVS/totalPixels, totalMSSSIM/totalPixels, totalHVMAF/totalPixels))
