...
./bins/ffmpeg -y -hide_banner -loglevel fatal -i "encoded/$filename.jpeg" -vf scale=flags=lanczos+accurate_rnd+bitexact+full_chroma_int+full_chroma_inp,format=bgr24 -strict -1 "temp/enc_$filename.png"
